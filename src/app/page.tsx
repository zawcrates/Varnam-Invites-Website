...
export default function HomePage() {
  ...
  const faqs = [
    {
      q: "What happens after I purchase a wedding invitation?",
      a: "After successful payment verification, your Varnam wedding website is instantly published and live. You customize and preview all your wedding details before payment; once published upon purchase, your live website link is delivered directly to your email for sharing with your guests."
    },
    {
      q: "Can I preview the wedding invitation before buying it?",
      a: "Yes. You can preview and fully customize our digital wedding invitation templates before purchasing so you can see the exact design, animations, typography, and overall interactive experience."
    },
    {
      q: "How do I add my wedding details to the invitation?",
      a: "Varnam provides a simple live customization experience where you can enter details such as your names, wedding date, venue, location map, and event timeline before completing your purchase."
    },
    {
      q: "Do I need coding knowledge to customize my invitation?",
      a: "No. You don't need any coding or web development knowledge. Varnam is designed so couples can personalize their invitation effortlessly without editing any code."
    },
    {
      q: "Can I create my invitation using my phone?",
      a: "Yes. You can access Varnam from your smartphone and use all supported customization and preview features without needing a computer."
    },
    {
      q: "How do I share my digital wedding invitation with guests?",
      a: "Once your invitation is published upon payment, you can share its shareable web link with your guests through WhatsApp, Instagram, email, or any messaging platform."
    },
    {
      q: "Do my guests need to download an app?",
      a: "No. Your guests can open your digital wedding invitation directly through their web browser using the link you send them, with zero app installation required."
    },
    {
      q: "Do my guests need a Varnam account to view the invitation?",
      a: "No. Guests do not need an account or sign-in to view your published wedding invitation."
    },
    {
      q: "Will I need to buy a domain name for my wedding invitation?",
      a: "No. You don't need to purchase or configure a separate domain. Your published Varnam invitation comes with a lifetime shareable web link included."
    },
    {
      q: "Can I share my wedding invitation on WhatsApp?",
      a: "Yes. Varnam invitations are optimized for seamless sharing on WhatsApp, making it simple and elegant to invite friends and family digitally."
    },
    {
      q: "Can I make changes after payment?",
      a: "No. You can freely edit and customize all supported wedding details before payment. Once payment is completed and your invitation is published, editing is locked and cannot be modified."
    },
    {
      q: "Can I add multiple wedding events to my invitation?",
      a: "Depending on the template, you can include multiple celebrations such as your engagement, Haldi, Mehendi, Sangeet, wedding ceremony, and reception."
    },
    {
      q: "Can I add music to my digital wedding invitation?",
      a: "Yes. Background music is provided as part of supported template designs. Please note that custom background music uploads are not supported."
    },
    {
      q: "What is included with a Varnam wedding invitation?",
      a: "Your purchase includes lifetime server hosting, access to the selected digital invitation design, live customization, and an instant shareable link delivered directly to your email."
    },
    {
      q: "Are Varnam invitations mobile-friendly?",
      a: "Yes. Our digital wedding invitations are designed mobile-first, ensuring a stunning and responsive viewing experience across all smartphones and screen sizes."
    },
    {
      q: "Do you offer Tamil and South Indian wedding invitations?",
      a: "Yes. Varnam offers digital invitation designs inspired by Tamil, South Indian, and broader Indian wedding celebrations, alongside contemporary styles."
    },
    {
      q: "Can I use my invitation for a destination wedding?",
      a: "Yes. You can use suitable Varnam templates for destination weddings, beach weddings, and grand celebrations by entering your venue and event details during customization."
    },
    {
      q: "Do you create completely custom wedding invitations?",
      a: "Our primary service is our curated collection of pre-designed digital wedding invitation templates. If bespoke custom design services are available, they will be announced separately on our website."
    },
    {
      q: "Can I resell or share a Varnam template with someone else?",
      a: "No. Your purchase provides a personal-use licence for the associated wedding or event. Varnam templates may not be resold, redistributed, or commercially reproduced."
    },
    {
      q: "What is Varnam Invites' refund policy?",
      a: "Because our invitations are digital products, purchases are generally non-refundable after access has been provided. Exceptions apply for duplicate charges or technical non-delivery caused by us. Please see our Refund Policy for full details."
    }
  ];
